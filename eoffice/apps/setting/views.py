...
def index(request):
    ...
    return render_to_response('apps/'+app_name+'/index.html', constant, context_instance=RequestContext(request))
...
def appmoduleIndex(request):
    ...
    return render_to_response("apps/"+app_name+"/"+module+'/'+action+'.html', 
                              constant
                              )
